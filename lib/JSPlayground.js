...
var JSPlayground = module.exports = function (playgroundElement, jsStubText, userCodeArgumentsCallback) {
  ...
  this._jsEditor = new JSPlaygroundEditor(jsEditorElement, jsStubText)
