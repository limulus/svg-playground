...
var JavaScriptPlayground = require("./JavaScriptPlayground.js")
...
var SVGPlayground = module.exports = function (playgroundContainerElem) {
    ...
    this._svgContainerElem.style.height = "400px"
    this._svgContainerElem.style.float = "left"
    document.body.appendChild(this._svgContainerElem)

    this._playgroundElem = document.createElement("div")
    this._playgroundElem.style.width = "50%"
    this._playgroundElem.style.height = "400px"
    this._playgroundElem.style.float = "left"
    document.body.appendChild(this._playgroundElem)

    this._jsPlayground = new JavaScriptPlayground(
    	this._playgroundElem,
    	new SVGPlaygroundJSTemplate(),
